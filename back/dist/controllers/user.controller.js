...
exports.logoutUser = exports.loginUser = exports.createUser = exports.getUser = void 0;
...
var createUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, typeorm_1.getRepository(User_1.User).findOne({ email: req.body.email })];
            case 1:
                user = _a.sent();
                if (!user) return [3 /*break*/, 2];
                // return res.status(401).send('이미 가입된 사용자 입니다.');
                return [2 /*return*/, res.status(200).json({ isError: true, message: '이미 사용중인 이메일입니다.' })];
            case 2: return [4 /*yield*/, typeorm_1.getRepository(User_1.User).create({
